...
class PostureData:
    def __init__(self,
        ...
        self.sensor_data = {
            "arduinoData": {
                ...
                "postureCorrect": posture_correct
            },
            "ultrasonicSensor": {
        ...
        self.posture_classification = {
            "sitting": sitting,
            "postureCorrect": posture_correct,
            "ultrasonicDistance": ultrasonic_distance,
    ...
    def to_dict(self) -> dict:
        return {
            ...
            "sitting": self.posture_classification["sitting"],
            "postureCorrect": self.posture_classification["postureCorrect"],
            "ultrasonicDistance": self.posture_classification["ultrasonicDistance"]
